...
from Utils.Split.IncrementalSparseMatrix import IncrementalSparseMatrix
...
def split_train_leave_k_out_user_wise(URM, k_out = 1, use_validation_set = True, leave_random_out = True):
    ...
    for user_id in range(n_users):
        ...
        if use_validation_set:
            ...
            # TODO: modification in order to make work the function
            #URM_validation_builder.add_data_lists([user_id]*k_out, user_interaction_items_validation, user_interaction_data_validation)
            URM_validation_builder.add_data_lists([user_id] *len(user_interaction_items_validation), user_interaction_items_validation,
