...
class GenericRunner(object):
    ...
    def write_submission(users, self):
        """
        ...
        recommender = Hybrid(self.urm_train, self.icm, self.p_icfknn, self.p_ucfknn, self.p_cbfknn, self.p_slimbpr,
    ...
    def evaluate(self):
        ...
        recommender = Hybrid(self.urm_post_validation, self.icm, self.p_icfknn, self.p_ucfknn, self.p_cbfknn,
                             self.p_slimbpr, self.p_puresvd, self.p_als, self.p_cfw, weight)
        recommender.fit()
